...
function layout ()
{
    ...
    cat "$SCRIPT_DIR/runnercoreassets" | xargs rm -f
    find . -empty -type d -delete
    find . -type f > "$LAYOUT_TRIMS_DIR/runtime/runnerdotnetruntimeasserts"
    popd > /dev/null
    ...
    cat "$LAYOUT_TRIMS_DIR/runtime/runnerdotnetruntimeasserts" | xargs rm -f
